...
#include "../includes/tb_WIFI_gimbal_command_in_Monitor.h"

int mon_get_sender_id(void);
int monsig_emit(void);

SW__MISSING_TYPE_Impl contents[1];
...
bool mon_dequeue(SW__MISSING_TYPE_Impl * m) {
...
bool mon_enqueue(const SW__MISSING_TYPE_Impl * m) {
