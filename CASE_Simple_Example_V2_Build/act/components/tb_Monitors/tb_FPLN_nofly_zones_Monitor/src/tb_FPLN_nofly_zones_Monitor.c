...
#include "../includes/tb_FPLN_nofly_zones_Monitor.h"

int mon_get_sender_id(void);
int monsig_emit(void);

SW__MapArray_Impl contents[1];
...
bool mon_dequeue(SW__MapArray_Impl * m) {
...
bool mon_enqueue(const SW__MapArray_Impl * m) {
